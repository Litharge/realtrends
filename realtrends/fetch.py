...
class TrendsFetcher:
    ...
    def scrape_trend(self, keywords, geo = "", time_range = "12-m", tz = "0", retry = True, token_no = 1):
        ...
        self.__get_token()
        # TODO a pause here makes an error more likely
        # indicates a speedup is needed, remove regex where possible
